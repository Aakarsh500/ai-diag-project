...
# Load Models
# Vercel Serverless functions sandbox strict folders, so models must be natively in the /api dir
...
def predict(data: FormData):
    ...
    return {
        ...
        "specificity": f"{(100 - (100 - confidence)/2):.1f}%"
    }

if __name__ == "__main__":
    import uvicorn
    # This allows you to run `python api/predict.py` manually for local Windows development
